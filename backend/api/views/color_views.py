...
from ..models import ExteriorColor, InteriorColor
from ..serializers import ExteriorColorSerializer, InteriorColorSerializer
...
def get_interior_colors(request):
    ...
    colors = InteriorColor.objects.all().order_by('name', 'upholstery')
